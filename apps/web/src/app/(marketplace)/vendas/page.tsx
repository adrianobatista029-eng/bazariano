...
import { listOrdersAsSeller, listReviewsByReviewer } from "@marketplace/supabase/queries";
...
export default async function VendasPage() {
  ...
  if (!orders?.length) return <p className="text-muted-foreground">Você ainda não recebeu pedidos.</p>;
